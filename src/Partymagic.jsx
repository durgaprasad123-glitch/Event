        ...
        <div>
            ...
            <div className="planner-gallery">
                <div className="gallery-item">
                    <img src="https://example.com/party1.jpg" alt="Birthday Party" />
                </div>
                <div className="gallery-item">
                    <img src="https://example.com/party2.jpg" alt="Wedding Decoration" />
                </div>
                <div className="gallery-item">
                    <img src="https://example.com/party3.jpg" alt="Corporate Event" />
                </div>
                <div className="gallery-item">
                    <img src="https://example.com/party4.jpg" alt="Anniversary Celebration" />
                </div>
            </div>
