        ...
        <div>
            ...
            <div className="planner-gallery">
                <div className="gallery-item">
                    <img src="https://example.com/corporate1.jpg" alt="Corporate Event 1" />
                </div>
                <div className="gallery-item">
                    <img src="https://example.com/corporate2.jpg" alt="Corporate Event 2" />
                </div>
                <div className="gallery-item">
                    <img src="https://example.com/corporate3.jpg" alt="Corporate Event 3" />
                </div>
                <div className="gallery-item">
                    <img src="https://example.com/corporate4.jpg" alt="Corporate Event 4" />
                </div>
            </div>
